...
def dji_robomaster_ep():
    ...
    while dji_choice != 3:
        ...
        if dji_choice == 1:
            dji_wheel_speed = input("enter wheel speed (integer from 1-10): ")
            dji_wheel_speed = int(dji_wheel_speed)

            while dji_wheel_speed < 1 or dji_wheel_speed > 10:
                dji_wheel_speed = input("enter wheel speed (integer from 1-10): ")
                dji_wheel_speed = int(dji_wheel_speed)

            print("setting wheel speed -----------------------------------------------------")
            msg = ("chassis wheel w1 %s w2 %s w3 %s w4 %s;" % (
                dji_wheel_speed, dji_wheel_speed, dji_wheel_speed, dji_wheel_speed))
...
def main():
    ...
    while 1:
        ...
        print("\n   8: connect to DJI RoboMaster EP")
        print("\n   9: quit\n")
